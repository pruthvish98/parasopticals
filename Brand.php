                                        ...
                                        <div class="card-body card-block">
                                            <div class="row form-group">
                                                <div class="col-12">
                                                    ...
                                                    <input placeholder="Brand Name" type="text" pattern="[a-zA-Z ]*$" required="true" title="Only Characters are Allowed"  name="txt1"  class="md-input">
                                                </div>
                                            </div>
                                        </div>
...
if (isset($_POST['btn1'])) {
    ...
    $check = checkdata($connection, "brand", "brand_name", $name);

    if ($check) {
    $q = mysqli_query($connection, "insert into brand(brand_name) values ('{$name}')") or die(mysqli_errno($connection));
    if ($q)
        {
